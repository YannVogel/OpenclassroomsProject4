...
class PostController
{
    ...
    public function getPostIntro($postId) : string
    {
        ...
        $post = $postManager->getPost($postId);
        /** @var PostEntity $post */
        return substr($post->getPostContent(), 0, 1000) . '...<br /><a class="float-right" href="index.php?displayPost=' . $post->getPostId() . '"><span class="fa faButtonLeft fa-book-open"></span>Lire la suite...</a>';
    }
